	...
	<div id="center">
		...
		<form method="post" id="update" action="/community/community_write">
			...
			<div class="update_table">
				...
				<div class="content">
					<textarea name="comm_con" id="content" style="width: 100%" placeholder="내용을 입력하세요"
						required="required"> ${dto.comm_con} </textarea>
				</div>

			</div>
			<div id="button" align="center">
				<button type="submit" id="save" class="save" value="완료">완료</button>
				<button type="button" id="cancel" value="취소" onclick="location.href='/community/comunity_list'">취소</button>
			</div>
		</form>
	</div>
