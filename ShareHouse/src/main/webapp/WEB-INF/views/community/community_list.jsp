	...
	<div id="center">
		...
		<!-- 검색창 -->
			...
			<div id="sequence" align="right">
				<!-- 여긴 모르겠으니 나중에 -->
				<form action="community_list" class="sequence_sort">
					<input type="hidden" name="sort" value="0"> <input
						type="submit" value="최신순" class="recent" />
				</form>
				<form action="community_list" class="sequence_sort">
					<input type="hidden" name="sort" value="1"> <input
						type="submit" value="조회수 순" class="view" />
				</form>
			</div>
