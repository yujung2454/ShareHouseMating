							...
							<ul>
								<li class="faq">
									...
									<div class="faq_answer">
										입주 신청서를 제출하면 접수 확인 문자가 발송됩니다. 신규 지점을 신청하신 경우 본인이 선택한 우주 하우스 투어
										하루 전 날 확인 전화를 드리며,<br> 기존 지점을 신청하신 경우 입주 신청 후 2 일 내에 하우스
										매니저가 우주 하우스 투어 일정 조율을 위해 전화를 드립니다.<br> 우주 하우스 투어 일정이 확정되면
										해당 일시에 희망 지점을 방문하여 집을 둘러보고, 하우스 매니저와 간단한 인터뷰 시간을 가지게 됩니다.
									</div>
								</li>
								<li class="faq">
									...
									<div class="faq_answer">
										...
										납부 해주셔야 합니다. 계약기간 내 납부해주신 <span style="color: red"> 선불
											공과금은 퇴실 시 정산하고 정산후 생긴 차액은 반환 되거나 혹은 보증금에서 차감됩니다. </span><br>
								...
								<li class="faq">
									<div class="faq_question">4. 공과금을 왜 '선불 공과금'이라고 부르나요? 이게
										왜 필요하죠?</div>
									<div class="faq_answer">
										...
										한다는 불편이 있습니다. 우주는 이 점을 개선하고자 <span style="color: red">우주인이
											미리 지정된 고정 금액을 매달 선불로 납부하는 방식</span>으로 공과금 제도를 운영하고 있습니다.<br>
									</div>
								</li>
								<li class="faq">
									<div class="faq_question">5. 선불 공과금과 실제 사용금액에 차이가 나면 어떻게
										하나요?</div>
									<div class="faq_answer">
										납부한 선불 공과금은 퇴실 시 실제 사용금액과 비교되어 정산됩니다.<br> 계약기간 동안 납부한 선불
										공과금보다 실제 사용금액이 적은 경우, 퇴실 후 보증금 반환시 차액만큼 더 반환됩니다. <br> 반대로
										실제 사용금액이 더 많은 경우, 보증금이 차액만큼 차감되어 반환됩니다
									</div>
								</li>
								<li class="faq">
									<div class="faq_question">6. 공과금은 어떤 절차로 납부하나요?</div>
									<div class="faq_answer">
										임대료와 동일하게 우주가 안내하는 대로 납부하시면 됩니다. 단, 실제로 거주했는지 여부와 관계 없이 계약기간을
										기준으로 부담하는 것이 원칙입니다.<br> 즉, 계약기간 중 개인사정으로 집을 비우는 기간이
										발생하더라도 해당기간이 공과금 산정기간에서 제외되지 않습니다.
									</div>
								</li>
								<li class="faq">
								...
								<li class="faq">
									...
									<div class="faq_answer">WOOZOO는 현재 입주자 분께 계약 종료일로부터 2개월
										전에 재계약 의사를 문의 드리며, 재계약 의사가 없으실 경우, 계약종료일에 하우스 매니저의 시설 점검을 후
										시설에 이상이 없을 시 퇴실 하게 됩니다. 퇴실 시 열쇠는 반납하셔야 하며, 보증금은 계약종료일로부터 3 일
										이내에 돌려드립니다.</div>
								</li>
								<li class="faq">
									<div class="faq_question">9. 입주 시 지켜야 할 규정이 있나요?</div>
									<div class="faq_answer">
										계약사항에 위배되지 않는한 WOOZOO는 입주자분들의 개인생활에 관여하지 않습니다.<br> 다만, 같은
										지점에 거주하는우주인들은 입주 후 협의 하에 ‘주거규칙 가이드라인’을 만들어 원활한 셰어 라이프를 지켜나갑니다.
									</div>
								</li>
								<li class="faq">
									<div class="faq_question">10. 입주 후 추가 수납공간 및 기타 시설이 필요할
										경우 어떻게 하나요?</div>
									<div class="faq_answer">계약 전 우주 하우스 투어를 통해 수납공간과 시설에 대한
										충분한 숙지 후 계약을 진행하므로 WOOZOO는 입주 후 추가 시설 또는 기타 물품 (수납장, 정수기 등) 에
										대한 지원을 진행하지 않습니다. 이 점 양해 부탁 드립니다!</div>
								</li>
								<li class="faq">
								...
								<li class="faq">
									...
									<div class="faq_answer">
										크기와 종류에 관계 없이 모든 반려/애완동물을 키울 수 없으며, 이를 위반할 경우 계약 내용에 따라 퇴거요청을
										받을 수 있습니다. <br> 이는 룸메이트나 해당 집의 입주자 전원이 동의하더라도 마찬가지입니다.
									</div>
								</li>
							</ul>
						</div>
						<div class="contract">
							<ul>
								<li class="faq">
									...
									<div class="faq_answer">
										입주 계약은 6개월 단위로 체결 가능합니다. WOOZOO HOUSE는 거주자 커뮤니티 형성과 셰어하우스
										문화정착을 위해 6개월 단위로 거주 계약을 진행하고 있습니다. <br> 다만 프로모션 정책에 따라
										지점별로 최소 계약기간이 상이하니(최소 2개월) '지점소개' 란을 참고해 주세요.
									</div>
								</li>
								<li class="faq">
									...
									<div class="faq_answer">
										...
										보증금을 납부하셔야 하며, 월세는 입주 2일 전까지 납부해야 합니다.<br> 위 사항을 지키지 못 하실
										경우 계약은 통보 없이 자동으로 취소되오니, 이 점 양해 부탁 드립니다.
									</div>
								</li>
								<li class="faq">
									<div class="faq_question">3. 입주기간을 연장할 수 있나요?</div>
									<div class="faq_answer">입주기간은 초기 계약과 마찬가지로 6개월 단위로 연장하게
										됩니다. 재계약을 원하실 경우, 계약 종료일로부터 두 달 전에 하우스 매니저께 재계약 의사를 밝혀주셔야 하며,
										재계약은 입주자 간 상호 만족도 조사와 담당자 소견을 바탕으로 결정됩니다.</div>
								</li>
								<li class="faq">
									<div class="faq_question">4. 보증금은 납부하였으나 아직 입주 전 입니다. 만약
										현 상황에서 계약 취소 시 어떻게 되나요?</div>
									<div class="faq_answer">입주 전 계약을 해지하는 경우, 계약시작일까지 남은 기간에
										따라 다른 액수의 보증금이 차감됩니다. 자세한 사항은 계약서를 참조하시기 바랍니다.</div>
								</li>
								<li class="faq">
									<div class="faq_question">5. 보증금과 월세는 얼마인가요?</div>
									<div class="faq_answer">
										임대료는 집에 따라 다르기 때문에, 입주를 희망하시는 집의 상세 소개페이지에서 확인해주시는 것이 가장
										정확합니다. <br> 마찬가지로 보증금도 집에 따라 달라지며, 입주를 희망하시는 방 월세의 2개월 분
										금액입니다. <br> (예를 들어 월세가 40만원인 방에 입주 하시면, 보증금은 80만원입니다.)
									</div>
								</li>
								<li class="faq">
								...
								<li class="faq">
									...
									<div class="faq_answer">보다 빠르고 친밀한 커뮤니티 형성을 위해, 입주하시는 분들의
										연령은 20세부터 41세까지로 정하고 있습니다.</div>
								</li>
								<li class="faq">
									<div class="faq_question">8. 입주 및 계약 문의는 어디로 해야하나요?</div>
									<div class="faq_answer">입주/계약문의는 전화(02-2018-3718) 및
										이메일(living@woozoo.kr) 로 영업시간(오전10시-오후6시)내에 문의하실 수 있습니다. 입주/계약에
										대한 궁금하신 점은 홈페이지의 FAQ를 통해 확인 하실 수 있으니 문의하시기 전에 FAQ를 확인해주세요!
										카카오톡 혹은 라인 메신저로는 상담 진행해드리지 않고 있으니 이 점 참고 부탁드립니다.</div>
								</li>
								<li class="faq">
								...
								<li class="faq">
									...
									<div class="faq_answer">아니오. 지점 내에서는 우주 직원이 상주하고 있지 않습니다.
									</div>
								</li>
							</ul>
						</div>
